...
def find_best_move(game_state: GameState) -> Move | None:
    """
    Function that finds the best move for the current game state.
    :param game_state: Current game state.
    :return: Best move or none.
    """
...
def minimax(move: Move, maximizer: Mark, choose_highest_score: bool = False) -> int:
    """
    Minimax algorithm function that returns either max or min score.
    :param move: Passed move argument.
    :param maximizer: Player's mark.
    :param choose_highest_score: Bool whether pick the highest score. Defaults to False.
